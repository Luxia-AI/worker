...
CONTRADICT_RATIO_FOR_FORCE_FALSE = float(os.getenv("CONTRADICT_RATIO_FOR_FORCE_FALSE", "0.50"))
CONTRADICT_RATIO_FORCE_FALSE = float(os.getenv("CONTRADICT_RATIO_FORCE_FALSE", str(CONTRADICT_RATIO_FOR_FORCE_FALSE)))
